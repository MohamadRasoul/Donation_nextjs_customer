    ...
    return (
        <>
            ...
            >
                ...
                <div className='flex flex-wrap items-center -mx-4 h-[40rem]'>
                    <Carousel className="absolute top-0 left-0 h-full custom-slider" autoplay={true}>
                        <img src='/assets/images/hero/1.jpg' className='object-cover object-center' height="250" />
                        <img src='/assets/images/hero/2.jpg' className='object-cover object-center' height="250" />
                        <img src='/assets/images/hero/3.jpg' className='object-cover object-center' height="250" />
                        <img src='/assets/images/hero/4.jpg' className='object-cover object-center' height="250" />
                        <img src='/assets/images/hero/5.jpg' className='object-cover object-center' height="250" />
                    </Carousel>
                    <div className='absolute flex justify-center w-full px-4 m-auto'>
                        <div className='text-center'>
                            <h1 className='text-5xl font-semibold text-white'>
                                Saved Dreams
                            </h1>
                            <p className='my-8 text-xl text-white w-[50rem] lg:mb-11'>
                                To support Humanitarian Relief Campaigns.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    ...
                    <div className='flex flex-wrap -mx-4'>
                        ...
                        <Link href={`/donationPost/cases`}>
                            <div className='w-full px-4 cursor-pointer md:w-1/2 lg:w-1/4'>
                                <div
                                ...
                                >
                                    <div className='relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-primary'>
                                        ...
                                        <img
                                            src="/assets/images/logo/cases.png"
                                            className="p-3 mx-auto rounded-full w-28 h-28 aspect-square"
                                        />
                                    </div>
                        ...
                        <Link href={`/donationPost/supportPrograms`}>
                            <div className='w-full px-4 cursor-pointer md:w-1/2 lg:w-1/4'>
                                ...
                                >
                                    ...
                                    <p className='mb-8 text-body-color lg:mb-11'>
                                        Learn more to improve your features
                                    </p>
            ...
            <section id='team' className='pt-20 pb-10 lg:pt-[120px] lg:pb-20'>
                <div className='container'>
                    ...
                    <div className='flex flex-wrap justify-center -mx-4'>
                        ...
                        <TeamCard name={'Hala Tatari'} image={'/assets/images/team/hala.jpg'} />
                        <TeamCard name={'Marah Roumieh'} image={'/assets/images/team/marah.jpg'} />
                        <TeamCard name={'Dania Martini'} image={'/assets/images/team/dania.jpg'} />
                        <TeamCard name={'Diana Nawlo'} image={'/assets/images/team/diana.jpg'} />
