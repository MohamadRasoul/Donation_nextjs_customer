    ...
    return (
        <>
                                ...
                                <ul className='flex flex-wrap items-center justify-center mb-10'>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            target='_blank'
                                            className='flex items-center px-6 py-4 text-base font-medium text-white transition duration-300 ease-in-out hover:opacity-70 sm:px-10'
                                        >
                                            Star on Github
                                            <span className='pl-2'>
                                                <svg
            ...
            <section className='relative z-20 overflow-hidden bg-[#f3f4ff] pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]'>
              ...
              '
                            >
                                <button className='flex items-center w-full text-left faq-btn'>
                    ...
                    <div className='flex flex-wrap'>
                        <div className='w-full mx-4'>
                            <div className='wow fadeInUp' data-wow-delay='.2s'>
                                ...
                                <div className='flex flex-wrap items-center ud-brands-logo'>
